...
interface GroupMovieDetailsProps {
  data: {
    movieTitle: string;
    moviePoster?: string;
    movieRating: string;
...
export const GroupMovieDetails: React.FC<GroupMovieDetailsProps> = ({ data }) => {
  return (
    <div className="flex items-start gap-6 pb-6 border-b border-gray-600/30">
      <div className="relative">
        <div className="w-20 h-28 bg-gradient-to-br from-purple-500 to-blue-600 rounded-xl shadow-lg flex items-center justify-center overflow-hidden">
          {data.moviePoster ? (
            <img 
