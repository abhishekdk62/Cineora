...
import { paymentTypes } from '../../../GroupInvite/PaymentGroupModal';
import { PaymentMethodListInvt } from './PaymentMethodListInvt';
import { PaymentButtonInvt } from './PaymentButtonInvt';
...
export default PaymentFormInvt
