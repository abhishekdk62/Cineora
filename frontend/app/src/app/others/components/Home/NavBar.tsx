...
export default function NavBar({ scrollToSection, handleClick }: NavBarProps) {
        ...
        {isMenuOpen && (
          <div className="md:hidden border-t border-gray-800/50 py-4">
            <div className="flex flex-col space-y-4">
              ...
              {isAuthenticated ? (
                <button className="bg-[#FF5A3C] text-white px-6 py-2 rounded-full hover:bg-[#e54a32] transition-colors font-medium w-fit">
                  Logout
                </button>
              ) : (
                <button
