...
export interface INotificationService {
  ...
  sendBookingNotification(userId: string, bookingData: BookingNotificationDataDTO): Promise<ServiceResponse<NotificationResponseDTO>>;
  sendPaymentNotification(userId: string, paymentData: PaymentNotificationDataDTO): Promise<ServiceResponse<NotificationResponseDTO>>;
  sendReminderNotification(userId: string, reminderData: ReminderNotificationDataDTO): Promise<ServiceResponse<NotificationResponseDTO>>;
  sendCancellationNotification(userId: string, cancellationData: CancellationNotificationDataDTO): Promise<ServiceResponse<NotificationResponseDTO>>;
}
