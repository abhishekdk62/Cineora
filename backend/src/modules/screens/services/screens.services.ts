...
export class ScreenService implements IScreenService {
  ...
  async createScreen(
    ...
    try {
      ...
      let data: IScreenInput = {
        theaterId: screenData.theater._id,
...
async deleteScreensByTheater(theaterId: string): Promise<ServiceResponse> {
  ...
  async getScreenById(screenId: string): Promise<ServiceResponse> {
    try {
      if (!screenId) {
        return {
          success: false,
  ...
  async getScreensByTheaterId(theaterId: string): Promise<ServiceResponse> {
    try {
      if (!theaterId) {
        return {
          success: false,
  ...
  async getScreenStats(theaterId: string): Promise<ServiceResponse> {
    try {
      if (!theaterId) {
        return {
          success: false,
...
async getAllScreens(
  ...
  async toggleScreenStatus(screenId: string): Promise<ServiceResponse> {
    try {
      if (!screenId) {
        return {
          success: false,
  ...
  async getScreenCountByTheaterId(theaterId: string): Promise<ServiceResponse> {
    try {
      if (!theaterId) {
        return {
          success: false,
