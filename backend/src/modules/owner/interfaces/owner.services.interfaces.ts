...
import { GenerateSignedUrlDto, GetOwnerRequestsFiltersDto, KYCSubmissionResponseDataDto, OwnerKYCDataDto, UploadFileDto, UploadMultipleFilesDto } from "../dtos/ownerReq.dtos";
