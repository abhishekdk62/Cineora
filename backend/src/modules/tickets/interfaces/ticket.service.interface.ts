...
export interface ITicketService {
  ...
  getTicketByIds(id: string[]): Promise<ITicket[]>;
  ...
  getTicketById(ticketId: string): Promise<ApiResponse<ITicket>>;
  getUserTickets(data: GetUserTicketsDto): Promise<ApiResponse<PaginatedTicketsResponseDto>>;
  markTicketAsUsed(ticketId: string): Promise<ApiResponse<ITicket>>;
  validateTicket(data: ValidateTicketDto): Promise<ApiResponse<any>>;
